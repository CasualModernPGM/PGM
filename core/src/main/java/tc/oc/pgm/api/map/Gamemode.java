...
public enum Gamemode implements ComponentLike {
  ...
  BRIDGE_SWAP("bridgeswap", "Bridge Swap", "Bridge Swap"),
  ...
  COUNTER_STRAT("cs", "Counter-Strat", "CS"),
  CROSSBOW_BLAST("cb", "Crossbow Blast", "CB"),
  ...
  GHOST_SQUADRON("gs", "Ghost Squadron", "GS"),
  INFECTION("infection", "Infection", "Infection"),
  ITEM_SUMO("is", "Item Sumo", "Item Sumo"),
  KING_OF_THE_FLAG("kotf", "King of the Flag", "KotF"),
  KING_OF_THE_HILL("koth", "King of the Hill", "KotH"),
  LIFESTEAL("lifesteal", "Blitz: Lifesteal", "Lifesteal"),
  MICRO_BATTLES("mb", "Blitz: Micro Battles", "MB"),
